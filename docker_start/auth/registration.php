...
?>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(!empty($name) && !empty($surname) && !empty($email) && !empty($message)) {
            ...
            if(check_length($name, 2, 25) && check_length($surname, 2, 50) && check_length($message, 2, 1000) && check_length($message2, 2, 1000) && $email_validate) {
                ...
                <div class="modal-body">
                    ...
                    <form id="register-form">
                        <fieldset class="form-group">
                            ...
                            <input type="text" name="firstname" class="form-control" id="formGroupExampleInput" placeholder="Иван" required>
                        </fieldset>
                        <fieldset class="form-group">
                            <label for="formGroupExampleInput2">Ваш телефон</label>
                            <input type="text" name="lastname" class="form-control" id="formGroupExampleInput2" placeholder="+79990000000">
                        </fieldset>
                        <fieldset class="form-group">
