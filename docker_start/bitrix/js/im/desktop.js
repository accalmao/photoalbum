...
;(function (window)
{
	...
	BX.desktop.prototype.setUserInfo = function (params)
	{
		...
		this.contentAvatar.appendChild(
			BX.create('a', { attrs : { href : this.userInfo.profile, title : BX.util.htmlspecialcharsback(this.userInfo.name), target: "_blank" }, props : { className : "bx-desktop-avatar" }, children: [
