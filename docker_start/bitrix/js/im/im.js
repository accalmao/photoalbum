...
BX.IM = function(domNode, params)
{
	...
	this.revision = 30; // api revieion - check include.php
	this.errorMessage = '';
...
BX.IM.prototype.openSettings = function(params)
{
	...
	if (!this.desktop.run() && this.messenger.popupMesseger == null && this.init)
		BX.bind(document, "click", BX.proxy(this.autoHide, this));
};
...
BX.IM.Desktop.prototype.openCallFloatDialog = function()
{
	...
	this.openTopmostWindow("callFloatDialog", 'BXIM.webrtc.callFloatDialog("'+BX.util.htmlspecialchars(this.webrtc.callOverlayTitleBlock.innerHTML)+'", "'+(this.webrtc.callVideo? this.webrtc.callOverlayVideoMain.src: '')+'", '+(this.webrtc.audioMuted?1:0)+')', {}, 'im-desktop-call');
};
