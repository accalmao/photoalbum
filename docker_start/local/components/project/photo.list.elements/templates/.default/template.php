                    ...
                    foreach ($arResult['PROGRAMS'] as $title => $programs): ?>
                        <div class="col">
                            <div class="card shadow-sm">
                                <img src="<?= $programs['IMG'] ?>" class="bd-placeholder-img card-img-top"
                                ...
                                <div class="card-body">
                                    <p class="card-text">Название фото: <?= $programs['NAME'] ?></p>
                                    <p class="card-text">Описание фото: <?= $programs['DECRIP'] ?></p>
